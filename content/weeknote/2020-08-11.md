...
Colm has been working on our [list of local plans](https://digital-land.github.io/dataset/local-plans/) using data from our [local plans prototype](https://local-plans-prototype.herokuapp.com/), and we’ve also started creating a backlog of data from local plans that we need to standardise for [RIPA](https://www.ripa.digital/) and [BOPS](https://bops.digital/).
