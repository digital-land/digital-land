...
Local planning authorities often lack the time and technology needed to set up automatically updating feeds of data. **We need the technology they use to solve this problem for them** so there’s as little additional burden placed on them as possible and they can focus on running the service.
